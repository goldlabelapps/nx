...
order: 250
title: Pricing
description: Start free and scale up
slug: /about/pricing
tags: NX°, javascript, nextjs, frontend, backend, resend, pricing
icon: cash
---
> [CleverText text="NX° as a Service (SaaS)"]

## NX° Pricing

SaaS ensures a hassle free experience with access to the latest improvements
...
For a one-time flat fee of **£1600**, we set up and configure NX for you, resolve any initial issues, and hand over the instance after two weeks. Ongoing management is not included, but you retain full control