...
|---|---|
| [Overview & Getting Started](/nx/dashboard) | This page |
| [Components Reference](/nx/design-system) | All exported components |
| [Actions Reference](/nx/actions) | All Redux thunk actions |
| [Hooks Reference](/nx/uberedux/hooks) | All custom React hooks |
| [CRUD System](/nx/crud) | Generic Firestore CRUD for any collection |
| [Push Notifications](/nx/notifications) | FCM push notification setup |
| [PWA Support](/nx/pwa) | Progressive Web App install prompt |
...
Dashboard requires Firebase to be configured via environment variables:
