...
icon: docs
tags: crud, state-management, dashboard
image: nx
---

The Dashboard CRUD system provides a zero-configuration, schema-driven way to manage any Firestore collection through a familiar Create / Read / Update / Delete interface.
