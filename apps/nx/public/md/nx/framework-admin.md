...
icon: docs
tags: framework, admin, dashboard
---
...
|---|---|
| [Framework Overview](/nx/framework-overview) | Architecture, cartridge concept, file structure |
| [Configuration](/nx/framework-config) | `T_Config` schema and the `config.json` contract |
| [Uberedux](/nx/framework-uberedux) | NX° global state management layer |
| [DesignSystem](/nx/framework-design-system) | Theming, MUI integration, and the `DesignSystem` cartridge |

### Cartridges

| Cartridge | Description |
|---|---|
| [Dashboard](/nx/dashboard) | Back-office administration panel |
