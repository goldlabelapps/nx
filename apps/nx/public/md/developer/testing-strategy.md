...
description: How We Prove Quality
icon: docs
tags: testing, quality-assurance, strategy
---

# How We Prove Quality at NX°
...
### 2. Theme Component Tests (Vitest + JSDOM)
...
- `pnpm --dir apps/nx test` runs nx app tests
- `pnpm --dir packages/theme test` runs theme package tests only
