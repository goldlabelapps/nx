  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center pt-28 sm:pt-36 pb-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <Editable file="apps/nx/src/config/statement.config.ts" field="badge" inline className="mb-8">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-[#0f172a]/15 text-xs font-semibold text-[#0f172a] backdrop-blur-md hover:bg-slate-50 transition-colors cursor-default shadow-sm dark:bg-[#f8fafc]/10 dark:border-[#f8fafc]/30 dark:text-[#f8fafc] dark:hover:bg-[#f8fafc]/15">
        ...
        {/* Hero Main Headline */}
        <Editable file="apps/nx/src/config/hero.config.ts" field="headline">
        ...
        {/* Subheadline */}
        <Editable file="apps/nx/src/config/hero.config.ts" field="subheadline" className="mt-6">
        ...
        <div className="mt-8 sm:mt-10 flex flex-wrap items-center justify-center gap-3 sm:gap-4">
          <Editable file="apps/nx/src/config/hero.config.ts" field="primaryCta" inline>
            <Button
          ...
          <Editable file="apps/nx/src/config/hero.config.ts" field="secondaryCta" inline>
            <Button
