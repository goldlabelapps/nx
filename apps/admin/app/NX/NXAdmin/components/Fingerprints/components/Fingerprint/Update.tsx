...
export default function Update({
    ...
    React.useEffect(() => {
        ...
        console.groupCollapsed('[Update] Avatar path debug');
        console.log('currentAvatar:', currentAvatar, currentAvatar ? getAvatarSrc(currentAvatar) : null);
        console.log('selectedAvatar:', selectedAvatar, selectedAvatar ? getAvatarSrc(selectedAvatar) : null);
        console.table(
    ...
    const handleSave = async () => {
        ...
        if (isIdentityEditor) {
            console.log('[Update] Saving avatar', {
                selectedAvatar,
                src: selectedAvatar ? getAvatarSrc(selectedAvatar) : null,
            });
        }
