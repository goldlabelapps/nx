...
export function showHelp() {
  ...
  console.log(`    ${colors.bold}${colors.brightGreen}packages${colors.reset} [sub]     Manage packages: ${colors.dim}status, build, test, bump, pack, publish, consume, update${colors.reset}`);
