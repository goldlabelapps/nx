...
const EchoPayIcon = forwardRef(function EchoPayIcon({ ...props }: TMovieClip, ref) {
    ...
    return (
        <svg width="512px" height="512px" viewBox="0 0 512 512">
            <g ref={logoRef} id="EchoPayIcon" stroke="none" fill="none" fillRule="nonzero">
                <path
